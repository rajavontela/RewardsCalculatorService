...
class RewardsCalculatorServiceApplicationTests {
	...
	void shouldReturnErrorAsThereAreOnly20CustomersLoaded() {
		assertEquals(rewardsCalculatorController.getLastThreeMonthsRewardsGiven(21).getError(), true);
	}
	...
	void shouldReturnResponseAsTheCustomerExists() {
		CalculatedRewardsResponse crr = (CalculatedRewardsResponse) rewardsCalculatorController.getLastThreeMonthsRewardsGiven(1).getResult();
	...
	void shouldReturnZeroResultResponseForTheCustomer4() {
		CalculatedRewardsResponse crr = (CalculatedRewardsResponse) rewardsCalculatorController.getLastThreeMonthsRewardsGiven(4).getResult();
	...
	void shouldReturnZeroResultResponseForTheCustomer8() {
		CalculatedRewardsResponse crr = (CalculatedRewardsResponse) rewardsCalculatorController.getLastThreeMonthsRewardsGiven(8).getResult();
	...
	void shouldReturnResultResponseForTheCustomer10() {
		CalculatedRewardsResponse crr = (CalculatedRewardsResponse) rewardsCalculatorController.getLastThreeMonthsRewardsGiven(10).getResult();
